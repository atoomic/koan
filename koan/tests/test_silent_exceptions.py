...
ALLOWLIST: Set[Tuple[str, int]] = {
    ...
    ("run.py", 1698),                # _get_koan_branch: git rev-parse fallback
    ("run.py", 1879),                # _cleanup_temp_files: unlink best-effort
    ...
    ("run.py", 1672),                # get current branch (best-effort)
    ("run.py", 1848),                # temp file cleanup
