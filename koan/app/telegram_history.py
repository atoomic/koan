...
Handles saving, loading, formatting, and compacting the conversation
history stored in telegram-history.jsonl and previous-discussions-topics.json.
"""
...
def save_telegram_message(history_file: Path, role: str, text: str):
    ...
    try:
        ...
        print(f"[telegram_history] Error saving message: {e}")
